...
! function(t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = _, e.getIn = y, e.set = g, e.setIn = m, e.update = I, e.updateIn = T, e.merge = O, e.mergeDeep = b, e.mergeIn = A, e.omit = S, e.addDefaults = w;
    /*!
     * Timm
     *
                                    ...
                                    a && t.forEach(function(t, i) {
                                        ...
                                        ! function(t) {
                                            var e = t.store,
                                                ...
                                                T = c.id;
                                            k(E, a) && (T = U(n, T));
                                            var O = v.hasBoundaryNodes && i ? g.getClosestElement(i, A) : null;
                                ...
                                dt(d, function(e, o, c) {
                                    ...
                                    if (B(p, r.mediaQueryKey)) {
                                        var v = function() {
                                            ...
                                            Y(i, f) || n.dispatch((0, y.eventStateChanged)(c, i))
                                        };
    ...
    function ht(t) {
        ...
        (0, v.default)(n, function(t) {
            if (!t.continuous) {
                var n = t.actionListId,
                    r = t.verbose;
                gt(t, e), r && e.dispatch((0, y.actionListPlaybackChanged)({
                    actionListId: n,
                    isPlaying: !1
                }))
            }
    ...
    function Et(t) {
        var e = t.store,
            ...
            a = e.getState(),
            u = a.ixInstances,
            c = a.ixSession.hasBoundaryNodes && r ? g.getClosestElement(r, A) : null;
        (0, v.default)(u, function(t) {
            var r = (0, s.default)(t, "actionItem.config.target.boundaryMode"),
                a = !i || t.eventStateKey === i;
            if (t.actionListId === o && t.eventId === n && a) {
                if (c && r && !g.elementContains(c, t.element)) return;
                gt(t, e), t.verbose && e.dispatch((0, y.actionListPlaybackChanged)({
                    actionListId: o,
                    isPlaying: !1
                }))
            }
    ...
    function _t(t) {
        ...
        var S = v.hasBoundaryNodes && i ? g.getClosestElement(i, A) : null,
            w = F(b),
            R = !1;
    ...
    function gt(t, e) {
        ...
        var n = t.elementId,
            ...
            o = i.ref;
        i.refType === S && W(o, r, g), e.dispatch((0, y.instanceRemoved)(t.id))
    }
    ...
    t.exports = function(t, e, n, E, _, y) {
        ...
        if (A && !O) return y || (y = new r), g || f(t) ? i(t, e, n, E, _, y) : o(t, e, I, n, E, _, y);
        if (!(n & l)) {
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        switch (r.actionTypeId) {
            ...
            case at:
                var a, u, c = i(t, P),
                    s = i(t, M);
                return a = r.config.widthUnit === W ? It.test(c) ? parseFloat(c) : parseFloat(n.width) : (0, f.default)(parseFloat(c), parseFloat(n.width)), u = r.config.heightUnit === W ? It.test(s) ? parseFloat(s) : parseFloat(n.height) : (0, f.default)(parseFloat(s), parseFloat(n.height)), {
                    widthValue: a,
                    heightValue: u
                };
            case ut:
        ...
        var e = t.element,
            n = t.actionItem,
            r = t.elementApi;
        if ((0, _.isPluginType)(n.actionTypeId)) return (0, _.getPluginDestination)(n.actionTypeId)(n.config);
        switch (n.actionTypeId) {
            case J:
            case tt:
            case et:
            ...
            case at:
                ...
                if (d === W) {
                    var g = c(e, P);
                    s(e, P, ""), h = f(e, "offsetWidth"), s(e, P, g)
                }
                if (p === W) {
                    var m = c(e, M);
            ...
            case ot:
                return n.config.fontVariations.reduce(At, {});
            default:
            ...
            case K:
                return function(t, e, n, r, i) {
                    var o = Ct.map(function(t) {
                        ...
                        a = i.setStyle;
                    Mt(t, y.TRANSFORM_PREFIXED, i), a(t, y.TRANSFORM_PREFIXED, o), u = r, c = n, s = u.actionTypeId, f = c.xValue, l = c.yValue, d = c.zValue, (s === J && void 0 !== d || s === tt && void 0 !== d || s === et && (void 0 !== f || void 0 !== l)) && a(t, y.TRANSFORM_STYLE_PREFIXED, R);
                    var u, c, s, f, l, d
                }(t, e, n, i, a);
            case q:
                    ...
                    switch (r.actionTypeId) {
                        case at:
                            var u = r.config,
                                ...
                                p = n.widthValue,
                                v = n.heightValue;
                            void 0 !== p && (s === W && (s = "px"), Mt(t, P, o), a(t, P, p + s)), void 0 !== v && (d === W && (d = "px"), Mt(t, M, o), a(t, M, v + d));
                            break;
                        case it:
                            ! function(t, e, n, r) {
                        ...
                        case st:
                            var h = pt[r.actionTypeId],
                                ...
                                g = n.aValue;
                            Mt(t, h, o), a(t, h, g >= 1 ? "rgb(".concat(E, ",").concat(_, ",").concat(y, ")") : "rgba(".concat(E, ",").concat(_, ",").concat(y, ",").concat(g, ")"));
                            break;
                        default:
                            var m = r.config.unit,
                                I = void 0 === m ? "" : m;
    ...
    }, e.getMaxDurationItemIndex = Vt, e.getActionListProgress = function(t, e) {
    ...
    var f = s(n(270)),
        ...
        pt = Object.freeze((r = {}, (0, c.default)(r, ut, D), (0, c.default)(r, ct, j), (0, c.default)(r, st, F), r)),
        vt = Object.freeze((i = {}, (0, c.default)(i, y.TRANSFORM_PREFIXED, I), (0, c.default)(i, D, m), (0, c.default)(i, x, x), (0, c.default)(i, C, C), (0, c.default)(i, P, P), (0, c.default)(i, M, M), (0, c.default)(i, L, L), i)),
        ht = {},
        Et = 1;
    var _t = 1;
    var yt = function(t, e) {
    ...
    function mt(t) {
        ...
        if (P ? (N = L.limitAffectedElements, x = M, C = l(L)) : x = C = l({
            ...
            var D = a && (C || !0 === w) ? [a] : d(M);
            if (C) {
                if (w === k) return d(C).filter(function(t) {
        ...
        return null == x || null == C ? [] : y.IS_BROWSER_ENV && u ? d(C).filter(function(t) {
            return u.contains(t)
        }) : N === G ? d(x, C) : N === X ? p(d(x)).filter(E(C)) : N === V ? h(d(x)).filter(E(C)) : d(C)
    }
    var It = /px/,
        Tt = function(t, e) {
    ...
    var wt = (o = {}, (0, c.default)(o, J, Object.freeze({
            xValue: 0,
            yValue: 0,
            zValue: 0
        ...
        if (y.IS_BROWSER_ENV) {
            ...
            if (r) {
                var i = n.getStyle,
                    ...
                    a = i(t, B);
                if (a) {
                    var u = a.split(H).map(dt); - 1 === u.indexOf(r) && o(t, B, u.concat(r).join(H))
                } else o(t, B, r)
            }
        }
    }
        ...
        if (y.IS_BROWSER_ENV) {
            ...
            if (r) {
                var i = n.getStyle,
                    o = n.setStyle,
                    a = i(t, B);
                a && -1 !== a.indexOf(r) && o(t, B, a.split(H).map(dt).filter(function(t) {
                    return t !== r
                }).join(H))
            }
        }
    ...
    function Ft(t) {
        ...
        e.actionItems.forEach(function(t) {
            var e, i = t.actionTypeId,
                o = t.config;
            e = (0, _.isPluginType)(i) ? (0, _.clearPlugin)(i) : Gt({
                effect: Xt,
                actionTypeId: i,
                elementApi: r
            }), mt({
    ...
    function Xt(t, e, n) {
        var r = n.setStyle;
        Dt(t, e, n), r(t, e, ""), e === y.TRANSFORM_PREFIXED && r(t, y.TRANSFORM_STYLE_PREFIXED, "")
    }
    ...
    var r = n(3),
        ...
        T = function(t, e) {
            ...
            if (y && !m)
                for (var D = 0, j = a.length; D < j; D++) {
                    var F = a[D];
                    M[F] = g(s, F, y.config)
                } else if (y && m && void 0 !== I && void 0 !== T)
                    for (var G = (A - I) / T, X = y.config.easing, V = h(X, G, f), k = 0, U = a.length; k < U; k++) {
                        var B = a[k],
                            W = g(s, B, y.config),
                            H = (g(s, B, m.config) - W) * V + W;
                        M[B] = H
                    }
            return (0, o.merge)(t, {
                position: A,
        ...
        O = function(t, e) {
            var n = t,
                ...
                T = I.duration,
                O = I.delay;
            null != p && (T = p), O = null != E ? E : O, c === _ ? T = 0 : (u || g) && (T = O = 0);
            var b = e.payload.now;
            if (r && i) {
                var A = b - (a + O);
                if (s) {
            ...
            handler: function(t) {
                ...
                switch (u) {
                    case h.EventBasedOn.VIEWPORT:
                        A = O ? Math.min(v, window.innerWidth) / window.innerWidth : Math.min(y, window.innerHeight) / window.innerHeight;
                        break;
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "selector": ".grid-teaser-item",
                "originalId": "61694bf29835097fe6e3e471|cdf6a277-0438-7d4d-6d86-5c91bcabf2e1",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".grid-teaser-item",
        ...
        "e-3": {
            ...
            "target": {
                "id": "61694bf29835097fe6e3e471|d7e416b2-d864-c2d6-9c68-eca3617407aa",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-5": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "61694bf29835097fe6e3e471|94e04c71-cc01-ad29-0019-917fa100c8f4",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
            ...
            "createdOn": 1636472657325
        }
    },
    "actionLists": {
        "a": {
            "id": "a",
            "title": "Grid Teaser Item Hover in",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-n",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".grid-teaser-img-bg",
                            "selectorGuids": ["8df90eb1-de65-70d8-2c59-9443946c4623"]
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
            ...
            "createdOn": 1636470977759
        },
        "a-2": {
            "id": "a-2",
            "title": "Grid Teaser Item Hover out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
                    "actionTypeId": "TRANSFORM_SCALE",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 120,
                        "target": {
                            "id": "61694bf29835097fe6e3e471|f77d190d-8c62-576c-c1fb-e6f391655994"
                        },
                        "xValue": null,
                        "yValue": null,
                        "zValue": 40,
